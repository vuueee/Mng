...
namespace Mng.Controllers
{
    public class PartsController : Controller
    {
        ...
        {
            /*
            var adminn = await _userManager.FindByEmailAsync("Admin@email.com");

            //Console.WriteLine(await _userManager.AddToRoleAsync(adminn, "Admin"));
            if(await _userManager.IsInRoleAsync(adminn, "Admin")) {
                Console.WriteLine( "Admin in Role!" );
            }
            if(await _userManager.IsInRoleAsync(await _userManager.GetUserAsync(HttpContext.User), "Admin")) {
                Console.WriteLine( "Current user in Role!" );
            }*/
